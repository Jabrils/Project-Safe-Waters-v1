...
{
    [CustomEditor(typeof(FlexSolidAsset))]
    public class FlexSolidAssetEditor : FlexAssetEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            m_previewMaterial = new Material(Shader.Find("Flex/DebugPoints"));
        }
        ...
        protected override CommandBuffer PreviewCommands()
        {
            ...
            FlexSolidAsset asset = target as FlexSolidAsset;
            if (asset)
            {
                ...
                if (m_particleBuffer != null && m_indexBuffer != null)
                {
                    ...
                    m_previewMaterial.SetColor("_Color", _auxFlexDrawParticles.SHAPE_COLORS[0]);
